...
public partial class AdminAddEditProductPage : ContentView
{
    ...
    public AdminAddEditProductPage()
    {
        InitializeComponent();
    ...
    private async void OnSaveClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                _imageStream.Position = 0;
                imageUrl = await FirebaseAuthService.Instance
            ...
            if (_isEditMode)
                await FirebaseAuthService.Instance.UpdateProductAsync(product);
            else
                await FirebaseAuthService.Instance.AddProductAsync(product);

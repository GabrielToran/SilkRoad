...
public partial class AdminLoginPage : ContentPage
{
    ...
    private async void OnSignInClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            await FirebaseAuthService.Instance.SignInAsync(email, password);

            // Verify this account is actually an admin
            var profile = await FirebaseAuthService.Instance
                .GetUserProfileAsync(FirebaseAuthService.Instance.CurrentUserId!);

...
public partial class AdminCategoriesPage : ContentPage
{
    ...
    private async void OnAddCategoryClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            await FirebaseAuthServices.Instance.AddCategoryAsync(cat);
            await LoadCategoriesAsync();
        }
        catch (Exception ex)
        {
    ...
    private async void OnEditCategoryClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            await FirebaseAuthServices.Instance.UpdateCategoryAsync(cat);
    ...
    private async void OnDeleteCategoryClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            await FirebaseAuthServices.Instance.DeleteCategoryAsync(cat.Id);

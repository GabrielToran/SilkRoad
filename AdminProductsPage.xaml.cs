...
public partial class AdminProductsPage : ContentView
{
    ...
    private async Task LoadProductsAsync()
    {
        ...
        try
        {
            _allProducts = await FirebaseAuthService.Instance.GetAllProductsAsync();
    ...
    private async void OnDeleteProductClicked(object sender, EventArgs e)
    {
        ...
        try
        {
            await FirebaseAuthService.Instance.DeleteProductAsync(product.Id);
